...
export default class Bullet {
    ...
    public tanks: Array<npcTank> = [];
    public players: Array<playerTank> = [];
    ...
    private destructionOfTheBaseEvent: Function;
    private bangCreateEvent: Function;
    private otherCollisionObject: Array<{x: number, y: number}>
    ...
    checkCollisionWithTank(pos:{x: number, y: number}, size: {x: number, y: number}) {
        return (
